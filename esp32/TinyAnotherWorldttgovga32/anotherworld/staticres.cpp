...
//JJ const uint16_t VirtualMachine::frequenceTable[] = {
const unsigned short int VirtualMachine::frequenceTable[] = {
...
//JJ const uint8_t Video::_font[] = {
const unsigned char Video::_font[] = {
