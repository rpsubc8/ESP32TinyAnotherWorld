 ...
 */
 ...
 struct VirtualMachine 
 {
  ...
  static const unsigned short int frequenceTable[]; //JJ static const uint16_t frequenceTable[];
  ...
  short int vmVariables[VM_NUM_VARIABLES]; //JJ int16_t vmVariables[VM_NUM_VARIABLES];
  unsigned short int _scriptStackCalls[VM_NUM_THREADS]; //JJ uint16_t _scriptStackCalls[VM_NUM_THREADS];
  unsigned short int threadsData[NUM_DATA_FIELDS][VM_NUM_THREADS]; //JJ uint16_t threadsData[NUM_DATA_FIELDS][VM_NUM_THREADS];
  ...
  unsigned char vmIsChannelActive[NUM_THREAD_FIELDS][VM_NUM_THREADS]; //JJ uint8_t vmIsChannelActive[NUM_THREAD_FIELDS][VM_NUM_THREADS];

  Ptr _scriptPtr;
  unsigned char _stackPtr; //JJ uint8_t _stackPtr;
  bool gotoNextThread;
  ...
  void initForPart(unsigned short int partId); //JJ void initForPart(uint16_t partId);
  ...
  void snd_playSound(unsigned short int resNum, unsigned char freq, unsigned char vol, unsigned char channel); //JJ void snd_playSound(uint16_t resNum, uint8_t freq, uint8_t vol, uint8_t channel);
  void snd_playMusic(unsigned short int resNum, unsigned short int delay, unsigned char pos); //JJ void snd_playMusic(uint16_t resNum, uint16_t delay, uint8_t pos);
